...
class IncidentsController extends BaseController
{
    ...
    public function handleDeleteIncidents(Request $request, Response $response, array $uri_args)
    {
    ...
    public function handleUpdateIncidents(Request $request, Response $response)
    {
    ...
    public function handleCreateIncidents(Request $request, Response $response) {     
    ...
    public function isValidIncident($request, array $incident)
    {
        ...
        foreach ($incident as $key => $value) {
            switch ($key) {
                ...
                case "date":
                    if (!$this->validation->isFormatedDate($value)) {
